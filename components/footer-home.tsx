  ...
  return (
    <footer className="flex justify-between p-4 px-20 items-center bg-linear-to-r from-blue-50 to-white">
        ...
        <div className="flex gap-4 text-gray-500">
            <Link href="https://twitter.com"><FaTwitter size={20} className="hover:text-blue-500"/></Link>
            <Link href="https://linkedin.com"><FaLinkedin size={20} className="hover:text-blue-500"/></Link>
